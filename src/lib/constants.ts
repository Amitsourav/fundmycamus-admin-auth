...
export const VALID_LOAN_TRANSITIONS: Record<string, string[]> = {
  ...
  [LoanStatus.APPLIED]: [LoanStatus.DOCS_PENDING, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
  [LoanStatus.DOCS_PENDING]: [LoanStatus.DOCS_VERIFIED, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
  [LoanStatus.DOCS_VERIFIED]: [LoanStatus.UNDER_REVIEW, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
  [LoanStatus.UNDER_REVIEW]: [LoanStatus.APPROVED, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
  [LoanStatus.APPROVED]: [LoanStatus.DOCUMENTATION, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
  [LoanStatus.DOCUMENTATION]: [LoanStatus.DISBURSED, LoanStatus.REJECTED, LoanStatus.WITHDRAWN],
